...
import { ShoppingBag, Plus, Calendar, DollarSign, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track your purchase history and earnings</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-700 mt-1">{purchases.length}</p>
            </div>
        ...
        <div className="bg-green-50 rounded-xl p-6 border border-green-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-green-600">Valid Purchases</p>
        ...
        <div className="p-6">
          {purchases.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">Create your first purchase to start earning</p>
              <button
                onClick={() => setShowModal(true)}
