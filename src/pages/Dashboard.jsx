...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const [earningsRes, referralsRes, purchasesRes] = await Promise.all([
        ...
        axios.get("http://localhost:4862/api/user/referrals"),
        axios.get("http://localhost:4862/api/purchase"),
      ]);
  ...
  const handlePurchase = async (e) => {
    ...
    try {
      await axios.post("http://localhost:4862/api/purchase", {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-500 mt-3">
          You can refer up to 8 people directly. Current referrals:{" "}
          {stats.directReferrals}/8
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Create a new purchase to trigger earnings
            </p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Copy your referral code and invite others
            </p>
          </button>
